        ...
        <?php if($convitesPendentes > 0): ?>
            <div class="card-notificacao">
                ...
                <div class="notificacao-content">
                    <strong>Atenção:</strong> Você tem <strong><?php echo e($convitesPendentes); ?> <?php echo e($convitesPendentes == 1 ? 'convite pendente' : 'convites pendentes'); ?></strong> aguardando a resposta dos alunos.
                    <a href="<?php echo e(route('professor.convites.enviados')); ?>">Acompanhar convites</a>
                </div>
            </div>
        <?php endif; ?>
...
</html><?php /**PATH C:\Users\ancel\Documents\MeusProjetos\Devventure---TCC\Devventure-TCC\Devventure-TCC\resources\views/Professor/dashboard.blade.php ENDPATH**/ ?>