...
<body>
    <div class="header">
        ...
        <p>Aluno: <strong><?php echo e($aluno->nome); ?></strong> | Turma: <?php echo e($turma->nome_turma); ?></p>
        <p>Data de Emissão: <?php echo e(date('d/m/Y')); ?></p>
    </div>

    <div class="summary">
        <strong>Resumo:</strong><br>
        Total de Exercícios da Turma: <?php echo e($dados->count()); ?><br>
        Entregues: <?php echo e($dados->where('status', 'Entregue')->count()); ?><br>
        Pendentes: <?php echo e($dados->where('status', 'PENDENTE')->count()); ?>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo e($item['data_envio']); ?></td>
                <td><?php echo e($item['nota']); ?></td>
                <td><?php echo e($item['conceito']); ?></td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
    </table>
</body>
</html><?php /**PATH C:\Users\ancel\Documents\MeusProjetos\Devventure---TCC\Devventure-TCC\Devventure-TCC\resources\views/Professor/relatorios/pdf_aluno_individual.blade.php ENDPATH**/ ?>